    ...
    <div class="container mx-auto px-4 py-6">
        <div class="flex justify-between items-center mb-6">
            <div class="flex items-center gap-3">
                <h1 class="text-2xl font-bold text-secondary">Crear Nuevo Script</h1>
        ...
        <div class="bg-white shadow-md overflow-hidden">
            <form action="{{ route('scripts.store') }}" method="POST" id="scriptForm">
                @csrf
                <div class="p-6 border-b">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            ...
                            <select name="location" id="location"
                                ...
                                <option value="header" {{ old('location') == 'header' ? 'selected' : '' }}>Header (head)
                                </option>
                                <option value="body" {{ old('location') == 'body' ? 'selected' : '' }}>Body (inicio)
                                </option>
                                <option value="footer" {{ old('location') == 'footer' ? 'selected' : '' }}>Footer (final)
                                </option>
                            </select>
                            @error('location')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        ...
                        <div class="flex items-center">
                            <div class="mt-6">
                                <label class="inline-flex items-center cursor-pointer">
                                    ...
                                    <span class="ml-2 text-gray-700">Activar inmediatamente</span>
                                </label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="space-y-3">
                            ...
                            <label class="flex items-center cursor-pointer">
                                <input type="radio" name="scope" value="specific"
                                    ...
                                    {{ old('scope') == 'specific' ? 'checked' : '' }} onchange="togglePageSelection()">
                    ...
                    <div id="pageSelectionContainer" class="mb-6 hidden">
                        ...
                        <select name="page_ids[]" id="page_ids" multiple
                            ...
                            @foreach ($pages as $page)
                                <option value="{{ $page->id }}"
                                    {{ is_array(old('page_ids')) && in_array($page->id, old('page_ids')) ? 'selected' : '' }}>
                                    {{ $page->title }}
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="description" id="description" rows="3"
                            class="shadow appearance-none border w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:border-primary rounded-2xl @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <div class="border mb-2 @error('code') border-red-500 @enderror">
                                <textarea name="code" id="codeEditor" class="hidden">{{ old('code') }}</textarea>
                            </div>
                        </div>
                        @error('code')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                ...
                <div class="p-6 bg-gray-50 flex justify-between">
                    <button type="button" id="testScriptBtn"
                        class="bg-blue-600 hover:bg-blue-600/90 text-white px-4 py-2 flex items-center rounded-full mr-2">
                    ...
                    <div>
                        <button type="submit" id="saveScriptBtn"
                            ...
                            <i class="ri-save-line mr-1"></i> Guardar Script
                        </button>
                    </div>
                </div>
            </form>
                ...
                <div class="bg-blue-500 text-white p-4 rounded-t-lg flex-shrink-0">
                    <div class="flex justify-between items-center">
                        <div class="flex items-center gap-3">
                            ...
                            <h3 class="text-xl font-bold">Guía: Cómo crear un Script</h3>
                        </div>
                ...
                <div class="p-6 space-y-6 overflow-y-auto flex-1">
                    ...
                    <div class="bg-blue-50 border-l-4 border-blue-500 p-4 rounded">
                        <p class="text-gray-700">
                            ...
                            Puedes crear scripts propios o integrar servicios de terceros como Google Analytics,
                            chat widgets, píxeles de seguimiento, etc.
                        </p>
                    </div>
                    ...
                    <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded">
                        ...
                        <ul class="text-sm text-yellow-900 space-y-1 list-disc list-inside">
                            <li>Usa el botón "Probar Script" antes de guardar</li>
                            <li>Guarda el script desactivado primero para probarlo</li>
                            <li>Envuelve tu código en <code class="bg-yellow-100 px-1 rounded">(function() { ...
                                    })()</code> para evitar conflictos</li>
