...
@section('content')
    <div class="container mx-auto px-4 py-6">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
            <h1 class="text-2xl font-bold text-secondary">Nueva Promoción</h1>
        ...
        <div class="bg-white shadow-md p-6">
            <form action="{{ route('promotions.store') }}" method="POST" enctype="multipart/form-data" id="promotionForm">
                ...
                <div class="mb-8">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex flex-col md:flex-row gap-4 mb-6">
                            <label class="flex items-center cursor-pointer">
                                <input type="radio" name="vigencia_type" value="days" class="mr-2" checked>
                    ...
                    <div id="days-section" class="vigencia-section">
                    ...
                    <div id="date-section" class="vigencia-section hidden">
                ...
                <div class="flex items-center justify-end space-x-4">
                    <button type="submit"
                        ...
                        <i class="ri-save-line mr-1"></i>Guardar Promoción
                    </button>
                </div>
            </form>
        </div>
