...
@section('content')
    <div class="container mx-auto px-4 py-6">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
            <h1 class="text-2xl font-bold text-secondary">Nuevo Banner</h1>
            ...
            <form action="{{ route('banners.store') }}" method="POST" enctype="multipart/form-data" id="bannerForm">
                ...
                <div class="mb-8">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="hidden" name="image_url" id="image_url_path" value="{{ old('image_url') }}">
                        ...
                        <div id="image_preview_container" class="{{ old('image_url') ? '' : 'hidden' }} mt-4">
                            <div class="relative inline-block">
                                <img id="image_preview" src="{{ old('image_url') ? old('image_url') : '#' }}"
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <input type="text" name="primary_button_text" id="primary_button_text"
                                        value="{{ old('primary_button_text') }}" maxlength="50"
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <input type="text" name="secondary_button_text" id="secondary_button_text"
                                        value="{{ old('secondary_button_text') }}" maxlength="50"
                                        placeholder="Ej: Más información, Contactar"
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" name="show_category" id="show_category" value="1"
                                    {{ old('show_category', true) ? 'checked' : '' }}
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" name="show_primary_button" id="show_primary_button"
                                    value="1" {{ old('show_primary_button', true) ? 'checked' : '' }}
                                    class="rounded border-gray-300 text-primary shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50">
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" name="show_secondary_button" id="show_secondary_button"
                                    value="1" {{ old('show_secondary_button', false) ? 'checked' : '' }}
                                    class="rounded border-gray-300 text-primary shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50">
                ...
                <div class="flex items-center justify-end space-x-4">
                    <button type="submit"
                        ...
                        <i class="ri-save-line mr-1"></i>Guardar Banner
                    </button>
                </div>
            </form>
        </div>
...
@section('scripts')
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            setupLoadingIndicator('bannerForm');
