...
@section('content')
    <div class="container mx-auto px-4 py-4">
        ...
        <div class="bg-white shadow rounded-xl">
            <form id="custom-block-form" action="{{ route('custom-blocks.update', $customBlock) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name"
                                value="{{ old('name', $customBlock->name) }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="category" id="category"
                                value="{{ old('category', $customBlock->category) }}" list="category-list"
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="description" rows="3"
                                class="shadow appearance-none border w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:border-primary rounded-2xl @error('description') border-red-500 @enderror">{{ old('description', $customBlock->description) }}</textarea>
                            @error('description')
                                <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <label class="toggle-switch">
                                    <input type="checkbox" name="active"
                                        {{ old('active', $customBlock->active) ? 'checked' : '' }}>
                                    <span class="toggle-slider"></span>
                                </label>
                                <span class="ml-3 text-sm text-gray-700">
                                    <span
                                        id="status-text">{{ old('active', $customBlock->active) ? 'Activo' : 'Inactivo' }}</span>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                            ...
                            <div class="flex space-x-4">
                                <label class="inline-flex items-center">
                                    <input type="radio" name="icon_type" value="remix"
                                        ...
                                        {{ old('icon_type', $customBlock->icon_type) == 'remix' ? 'checked' : '' }}>
                                    <span class="ml-2">Remix Icon</span>
                                </label>
                                <label class="inline-flex items-center">
                                    <input type="radio" name="icon_type" value="svg"
                                        class="icon-type-radio w-4 h-4 text-primary"
                                        {{ old('icon_type', $customBlock->icon_type) == 'svg' ? 'checked' : '' }}>
                        ...
                        <div id="remix-icon-selector" class="form-group"
                            {{ $customBlock->icon_type !== 'remix' ? 'style=display:none;' : '' }}>
                            <div class="mb-2">
                            ...
                            <input type="hidden" name="icon" id="selected-icon"
                                value="{{ old('icon', $customBlock->icon) }}">
                            ...
                            <div class="mt-2 flex items-center">
                                ...
                                <i id="selected-icon-preview"
                                    class="ri-{{ $customBlock->icon_type === 'remix' ? $customBlock->icon : 'layout-masonry-line' }} text-xl"></i>
                                <span id="selected-icon-name"
                                    class="ml-2 text-xs">{{ $customBlock->icon_type === 'remix' ? $customBlock->icon : 'layout-masonry-line' }}</span>
                            </div>
                        </div>

                        <!-- SVG input -->
                        <div id="svg-input" class="form-group"
                            {{ $customBlock->icon_type !== 'svg' ? 'style=display:none;' : '' }}>
                            <label for="svg-url" class="block text-sm font-bold text-gray-700 mb-2">URL del SVG</label>
                            <input type="text" name="svg-url" id="svg-url"
                                value="{{ old('icon', $customBlock->icon_type === 'svg' ? $customBlock->icon : '') }}"
                                class="shadow appearance-none border w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:border-primary rounded-full">
                ...
                <div class="px-6 pb-4">
                    ...
                    <div class="editor-container">
                        <button type="button" id="format-json-btn" class="format-btn"><i class="ri-code-line"></i>
                            Formatear</button>
                        <textarea id="json-editor" name="settings">{{ old('settings', is_array($customBlock->settings) ? json_encode($customBlock->settings, JSON_PRETTY_PRINT) : $customBlock->settings) }}</textarea>
                    </div>
                ...
                <div class="px-6 pb-6">
                    ...
                    <div class="tab-content active" id="html-tab">
                        <div class="editor-container">
                            <button type="button" id="format-html-btn" class="format-btn"><i class="ri-code-line"></i>
                                Formatear</button>
                            <textarea id="html-editor" name="html_content">{{ old('html_content', $customBlock->html_content) }}</textarea>
                        </div>
                    ...
                    <div class="tab-content" id="css-tab">
                        <div class="editor-container">
                            <button type="button" id="format-css-btn" class="format-btn"><i class="ri-code-line"></i>
                                Formatear</button>
                            <textarea id="css-editor" name="css_content">{{ old('css_content', $customBlock->css_content) }}</textarea>
                        </div>
                    ...
                    <div class="tab-content" id="js-tab">
                        <div class="editor-container">
                            <button type="button" id="format-js-btn" class="format-btn"><i class="ri-code-line"></i>
                                Formatear</button>
                            <textarea id="js-editor" name="js_content">{{ old('js_content', $customBlock->js_content) }}</textarea>
                        </div>
                    ...
                    <div class="tab-content" id="admin-js-tab">
                        <div class="editor-container">
                            ...
                            <textarea id="admin-js-editor" name="admin_js">{{ old('admin_js', $customBlock->admin_js) }}</textarea>
                        </div>
                ...
                <div class="flex justify-end px-6 pb-6 pt-2 border-t border-gray-200">
                    <button type="submit"
                        ...
                        <i class="ri-save-line mr-2"></i>Actualizar Bloque
                    </button>
                </div>
            </form>
        </div>
