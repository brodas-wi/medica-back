...
<head>
    ...
    <title>Vista previa - {{ $footer->name }}</title>
...
<body>
    <!-- Dummy content to showcase the footer -->
    <div class="dummy-content">
        <div>
            <h1 class="text-3xl font-bold text-gray-800 mb-4">Contenido de Ejemplo</h1>
            <p class="text-lg">Este es un contenido de ejemplo para mostrar cómo se vería el pie de página en un sitio
                real.</p>
        </div>
    </div>
    ...
    <div class="preview-info">
        <div class="preview-info-content">
            <div class="preview-info-text">
                <span><strong>Vista previa:</strong> {{ $footer->name }}</span>
            ...
            <div class="preview-info-actions">
                <a href="{{ route('footer.editor.edit', $footer->id) }}" class="preview-btn preview-btn-primary">
                    <i class="ri-edit-line"></i> Editar
                </a>
                <a href="{{ route('footers.index') }}" class="preview-btn preview-btn-secondary">
